...
public class BoardControl extends HttpServlet{
	...
	private void update(HttpServletRequest req, HttpServletResponse res) 
		...
		String view = "board.do?method=content&num=" + num;
		RequestDispatcher rd = req.getRequestDispatcher(view);
		rd.forward(req, res);
	}
	//글 다쓰고 디비 인서트
	private void insert(HttpServletRequest req, HttpServletResponse res) 
		...
		String view = "board.do?method=list";
		RequestDispatcher rd = req.getRequestDispatcher(view);
		rd.forward(req, res);
	}
	//디비 삭제
	...
	//글 내용 보여주기
	private void content(HttpServletRequest req, HttpServletResponse res) 
			throws ServletException, IOException{
		BoardManager manager = BoardManager.getInstance();
		String noStr = req.getParameter("num");
		if(noStr != null)noStr=noStr.trim();
	...
	//글쓰기 창 보여줌
	private void writeMode(HttpServletRequest req, HttpServletResponse res) 
			throws ServletException, IOException{
		String id = req.getParameter("id");
	...
	//편집창 보여주기
	private void editMode(HttpServletRequest req, HttpServletResponse res) 
			throws ServletException, IOException{
		BoardManager manager = BoardManager.getInstance();
		String noStr = req.getParameter("num");
		if(noStr != null)noStr=noStr.trim();
	...
	private void reply(HttpServletRequest req, HttpServletResponse res) 
		...
		String view = "board.do?method=content&num="+bnum;
		RequestDispatcher rd = req.getRequestDispatcher(view);
		rd.forward(req, res);
		/*
	...
	//리플 삭제
	private void redel(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException{
		ReplyManager manager = ReplyManager.getInstance();
